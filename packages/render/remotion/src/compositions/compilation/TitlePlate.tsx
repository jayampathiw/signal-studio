...
// Moved from projects/assemblex-factory/pilot/src/compositions/TitlePlate.tsx
// (P0.8-07) — unchanged. Fades out over its last CROSSFADE_FRAMES so it
// crossfades into the episode body that starts underneath it.
