    ...
    async (clip) => {
      ...
      if (semantic.verdict === 'retry') {
        ...
        return {
          scene: clip.scene_n,
          pass: 'A',
          verdict: terminal ? 'blocked' : 'failed',
