...
| ----------------------- | --------------------- | -------------------- | --------------------------------- | -------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Wild Eye (Wild Capture) | Wild Capture Facebook | ✅ Architecture done | `wild-eye-reel`, `wild-eye-brief` | `house-style.md`, `script-library.md`, `seo-examples.md` | `signal-studio-workspace/docs/archive/wild-eye/integration-and-video-pipeline.md` (archived from this repo in P0.6 — superseded by this doc + `video-generation-flow.md`) |
