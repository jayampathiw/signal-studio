...
> _execution economics_ of `long-form-pipeline-plan.md` (v1) — v1 stays as the
...
- [ ] ⬜ **H0.1 — Migration file.** Create
  ...
  Apply with `supabase db push`. _(If push complains about migration history,
  see memory `project-migration-apply` — repair, don't force.)_
